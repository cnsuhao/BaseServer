...
CREATE TABLE `ship` (
	...
	`type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '飞船类型',
	`owner_id` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '拥有者id',
	`lev` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '等级',
	`exp` BIGINT(8) UNSIGNED NOT NULL DEFAULT '0' COMMENT '经验',
	`star` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '星级',
	`equip1_type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '装备1类型',
	`equip2_type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '装备1类型',
	`equip3_type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '装备1类型',
	`equip4_type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '装备1类型',
	`equip5_type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '装备1类型',
	`equip6_type` INT(4) UNSIGNED NOT NULL DEFAULT '0' COMMENT '装备1类型',
	PRIMARY KEY (`id`),
