...
void login_kernel::CNetMsg::DumpMsg(const char* szReasion,...)
{
	...
	::LogSave("login_kernel::CNetMsg::DumpMsg szReasion:%s,msgtype:%d-msgsize:%d,idProcess:%d,idSocket:%d",buffer,m_unMsgType,m_unMsgSize,m_idProcess,m_idSocket);///日志记录
