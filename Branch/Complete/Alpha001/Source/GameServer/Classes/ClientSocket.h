...
const int	RECV_BUFFER_SIZE	= RELATION_SERVER_SOCKET_BUF;		// 应用程序自己的BUF
const int	SEND_BUFFER_SIZE	= RELATION_SERVER_SOCKET_BUF;		// 应用程序自己的BUF
...
public:
	...
	bool		Init(const char* szName, int nPort, int nBlockSecs = 0, int nSndBuf = 0, int nRcvBuf = 0);
...
public:
	...
	bool		SendPacketWithPadInfo(USHORT nMsgType,USHORT nMsgSize,const char* buf, int nLen, bool bFlush = false);
...
//#ifdef	ENCRYPT_ENABLE
	...
	//06.8.10 添加,发往StateServer 的加密信息////////////////////////////////////////
