...
* 修订记录
* 01 : Create New
* 02 : 2013-3-12 mengsongl : 修改错误的变量使用
*
**************************************************************************/
...
public:	// new traversal
	class	ConstIterator{
		...
		public: // application
            ...
            /* 02 : 2013-3-11 mengsongl : 修改错误的变量使用 (BEGIN) */
			void	Reset()								{ m_idx=0; m_nValid_Size=m_pSet->size(); }    /* error,pSet->m_pSet */
            /* 02 : 2013-3-11 mengsongl : 修改错误的变量使用 (END) */			
